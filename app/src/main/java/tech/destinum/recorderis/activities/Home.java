...
public class Home extends BaseActivity {
    ...
    private TextView mSnackTV, mMSG;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // get textview inside snackbar view
            mSnackTV = (TextView) mView.findViewById(android.support.design.R.id.snackbar_text);
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1)
                mSnackTV.setTextAlignment(View.TEXT_ALIGNMENT_CENTER);
            else
                mSnackTV.setGravity(Gravity.CENTER_HORIZONTAL);
            mSnackbar.show();
        }
